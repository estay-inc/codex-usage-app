...
Server. Usage values are displayed in the menu bar. To calculate rolling
one-hour and daily consumption, the app keeps up to 48 hours of timestamped
percentage samples in macOS `UserDefaults`. This history stays on the user's
Mac and is not transmitted to the project's maintainers or any
